...
Ext.define('Shopware.apps.PaypalUnifiedSettings.view.tabs.AdvancedCreditDebitCard', {
    ...
    snippets: {
        ...
        onboardingPendingMessage: '{s name="onboardingPendingMessage"}Your account is currenctly not eligible for accepting payments using Advanced Credit Debit Card.{/s}',
    },
