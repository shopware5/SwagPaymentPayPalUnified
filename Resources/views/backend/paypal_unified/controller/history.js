...
Ext.define('Shopware.apps.PaypalUnified.controller.History', {
    ...
    saleDetailsCallback: function (options, success, response) {
        ...
        if (!success) {
            Shopware.Notification.createGrowlMessage('{s name=growl/title}PayPal Unified{/s}', '{s name=growl/error}An error occurred while requesting the PayPal payment details{/s}');
            return;
        }
        ...
        if (responseObject.success) {
            ...
            Shopware.Notification.createGrowlMessage('{s name=growl/title}PayPal Unified{/s}', responseObject.message);
        }
