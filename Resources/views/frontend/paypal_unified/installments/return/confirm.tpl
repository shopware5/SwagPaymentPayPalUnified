...
{block name="frontend_checkout_confirm_submit"}
    <a class="button btn is--primary is--large right is--icon-right" href="{url controller=PaypalUnified action=return paymentId=$paypalInstallmentsPaymentId PayerID=$paypalInstallmentsPayerId forceSecure}">
