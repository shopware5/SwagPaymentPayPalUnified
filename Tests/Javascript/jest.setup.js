...
require('./../../Resources/views/frontend/_public/src/js/jquery.button-config.js');
require('./../../Resources/views/frontend/_public/src/js/jquery.swag-paypal-unified.express-checkout-button.js');
require('./../../Resources/views/frontend/_public/src/js/jquery.create-url-function.js');
