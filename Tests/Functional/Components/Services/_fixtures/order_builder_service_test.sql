...
INSERT INTO `swag_payment_paypal_unified_settings_general` (`id`, `shop_id`, `active`, `client_id`, `client_secret`, `sandbox`, `show_sidebar_logo`, `brand_name`, `landing_page_type`, `send_order_number`, `order_number_prefix`, `use_in_context`, `log_level`, `display_errors`, `advertise_returns`, `use_smart_payment_buttons`, `merchant_location`, `submit_cart`, `intent`) VALUES
    (1,	1,	1,	'AQOs-Zqi0kU3aLWsrLVActt1d1u2AhpdLeiddWssUq-y7WnT_kPv4TEFNkTShvrlLFlschWKIi9JCVkl',	'EMATe3fxb-01TvYZxs1QFKf2N2WpQjE_os-XtfBddY5hjyHJ71SEpU4dr7woMlWz5_OYw-kpSwMRQvoD',	1,	1,	'',	'Login',	0,	'',	0,	1,	1,	0,	0,	'germany',	1,	'CAPTURE');
