...
class PaypalUnifiedV2PayUponInvoiceCatchesInvalidAddressExceptionTest extends PaypalPaymentControllerTestCase
{
    ...
    public function testIndexActionCatchInvalidBillingAddressException()
    {
        ...
        static::assertLocationEndsWith($controller->Response(), 'address/index/invalidBillingAddress/1');
    }
    ...
    public function testIndexActionCatchInvalidShippingAddressException()
    {
        ...
        static::assertLocationEndsWith($controller->Response(), 'address/index/invalidShippingAddress/1');
    }
