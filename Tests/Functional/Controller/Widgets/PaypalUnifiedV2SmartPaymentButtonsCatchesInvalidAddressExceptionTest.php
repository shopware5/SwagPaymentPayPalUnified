...
class PaypalUnifiedV2SmartPaymentButtonsCatchesInvalidAddressExceptionTest extends PaypalPaymentControllerTestCase
{
     ...
     * @param string $issue
     *
     * @return Shopware_Controllers_Widgets_PaypalUnifiedV2SmartPaymentButtons
     */
