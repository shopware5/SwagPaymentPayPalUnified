...
(1, 1, 1, '', '', 'sandbox_client_id::replace::me', 'sandbox_client_secret::replace::me', 1, 0, '', 'NO_PREFERENCE', '', 1, 0, 0, 0, 1, 'CAPTURE', 'gold', 'rect', 'large', '', '', 'sandbox_paypal_payer_id::replace::me');
