...
class ThreeDSecureAuthorizationCanceledException extends Exception
{
    /**
     * @param int $code
     */
    ...
    {
        $messageTemplate = 'ThreeDSecure canceled with status: EnrollmentStatus: %s, AuthenticationStatus: %s, LiabilityShift: %s REASON: %s';
        $message = sprintf(
            $messageTemplate,
