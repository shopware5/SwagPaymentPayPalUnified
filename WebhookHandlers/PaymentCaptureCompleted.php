...
class PaymentCaptureCompleted extends AbstractWebhook implements WebhookHandler
{
    /**
    ...
    public function invoke(Webhook $webhook)
    {
        ...
        if ($shopwareOrderServiceResult->getPaymentStatusId() !== Status::PAYMENT_STATE_COMPLETELY_PAID) {
            $this->paymentStatusService->updatePaymentStatusV2($shopwareOrderServiceResult->getOrderId(), Status::PAYMENT_STATE_COMPLETELY_PAID);
        }
